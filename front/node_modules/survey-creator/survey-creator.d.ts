/*Type definitions for SurveyJS Creator JavaScript library v1.8.78
...
export declare class SurveyPropertyEditorBase implements Survey.ILocalizableOwner {
    ...
    getRendererContext(locStr: Survey.LocalizableString): Survey.LocalizableString;
...
export declare class SurveyElementEditorTabModel {
    ...
    koAfterRender: any;
    constructor(obj: any, properties: Array<Survey.JsonObjectProperty>, _name: any, options: ISurveyObjectEditorOptions, _readOnly?: boolean);
...
export declare class Toolbar {
    items: ko.ObservableArray<IAction> | Array<IAction>;
    constructor(items: ko.ObservableArray<IAction> | Array<IAction>);
...
export declare class SurveyHelper {
    ...
    static isCanModifyProperty(obj: Survey.Base, propertyName: string, options?: ISurveyCreatorOptions): boolean;
...
export declare class SurveyLiveTester {
    ...
    /**
      ...
      * @see IAction
      */
    toolbarItems: ko.ObservableArray<Survey.IAction>;
