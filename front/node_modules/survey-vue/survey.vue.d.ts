...
export declare class Page extends BaseVue {
    ...
    onPagePropertyChanged(value: string, oldValue: string): void;
    protected getModel(): Base;
    protected onMounted(): void;
...
export declare class PanelDynamicProgressV2 extends PanelDynamicProgress {
    get progressButtonSvgPath(): string;
}


export declare class Navigation extends BaseVue {
    showPrevBtn: boolean;
    showNextBtn: boolean;
    ...
    onPropertyChanged(value: string, oldValue: string): void;
    protected onMounted(): void;
    nextButtonMouseDown(): boolean;
    buttonMouseDown(): boolean;
    prevPage(): void;
    nextPage(): void;
...
export declare class DefaultTitle extends Vue {
    element: any;
    css: any;
    get showIcon(): any;
    changeExpanded(): void;
    getIconCss(isCollapsed: boolean): string;
    mounted(): void;
    beforeDestroy(): void;
}
...
export declare class QuestionVue<T extends Question> extends BaseVue {
    innerValue: any;
    question: T;
    css: any;
...
export declare class ActionViewModel extends BaseVue {
    item: Action;
    constructor(props: any);
    getModel(): Base;
    getComponentName(): string;
...
export declare class ActionBarItemViewModel extends BaseVue {
    item: Action;
    getModel(): Base;
}


export declare class ActionBarItemDropdownViewModel extends ActionBarItemViewModel {
}


export declare class ActionBarSeparatorViewModel extends Vue {
    item: any;
    get innerCss(): string;
}


export declare class ListItem extends BaseVue {
    item: Base;
    model: ListModel;
    constructor();
    getModel(): Base;
